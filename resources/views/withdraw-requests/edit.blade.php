...
@section('title', __('Edit Withdraw Requests'))
    ...
    <section class="section">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('withdraw-requests.update', $withdrawRequest->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" value="{{ isset($withdrawRequest) ? $withdrawRequest->amount : old('amount') }}" placeholder="{{ __('Amount') }}" required />
                                        @error('amount')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bank-id">{{ __('Bank Id') }}</label>
                                        <select class="form-select @error('bank_id') is-invalid @enderror" name="bank_id" id="bank-id" class="form-control" required>
                                            ...
                                            <option value="{{ $bank->id }}" {{ isset($withdrawRequest) && $withdrawRequest->bank_id == $bank->id ? 'selected' : (old('bank_id') == $bank->id ? 'selected' : '') }}>
                                                {{ $bank->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="bank_account_number" id="bank-account-number" class="form-control @error('bank_account_number') is-invalid @enderror" value="{{ isset($withdrawRequest) ? $withdrawRequest->bank_account_number : old('bank_account_number') }}" placeholder="{{ __('Bank Account Number') }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_account_name" id="bank-account-name" class="form-control @error('bank_account_name') is-invalid @enderror" value="{{ isset($withdrawRequest) ? $withdrawRequest->bank_account_name : old('bank_account_name') }}" placeholder="{{ __('Bank Account Name') }}" />
