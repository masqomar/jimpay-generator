<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" name="bank_id" id="bank-id" class="form-control @error('bank_id') is-invalid @enderror" value="{{ isset($withdrawRequest) ? $withdrawRequest->bank_id : old('bank_id') }}" placeholder="{{ __('Bank') }}" />
            @error('bank_id')
            <span class="text-danger">
                {{ $message }}
            </span>
