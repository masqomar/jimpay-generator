                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('user-profile-information.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="first_name">{{ __('Nama Keren') }}</label>
                                <input type="text" name="first_name" class="form-control  @error('first_name', 'updateProfileInformation') is-invalid @enderror" id="first_name" placeholder="{{ __('Nama Keren') }}" value="{{ old('first_name') ?? auth()->user()->first_name }}" required>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="/user/two-factor-authentication">
                            ...
                            <button class="btn btn-danger mt-3" type="submit">{{ __('Disable Two Factor Authentication') }}</button>
                            @else
