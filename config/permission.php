...
return [
    ...
    'permissions' => [
        ...
        ['group' => 'withdraw requests', 'access' => ['withdraw request view', 'withdraw request create', 'withdraw request edit', 'withdraw request delete']],
        ['group' => 'ppob accounts', 'access' => ['ppob account view', 'ppob account create', 'ppob account edit', 'ppob account delete']],
    ],
];
